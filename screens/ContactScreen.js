...
export default function ContactScreen({ navigation }) {
  ...
  const checkUnreadConversations = () => {
    fetch(`https://colab-backend-iota.vercel.app/messages/conversations/unread/${user.token}`, {
      method: 'GET',
      headers: {
  ...
  const fetchContacts = () => {
    ...
    fetch(`https://colab-backend-iota.vercel.app/propositionCollabs/collaboration/contact`, {
      method: 'POST',
